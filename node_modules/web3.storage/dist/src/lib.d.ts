...
export class Web3Storage implements Service {
     ...
     */
    static put({ endpoint, token, rateLimiter }: Service, files: Iterable<Filelike>, { onRootCidReady, onStoredChunk, maxRetries, maxChunkSize, wrapWithDirectory, name }?: import("./lib/interface.js").PutOptions | undefined): Promise<CIDString>;
    /**
     * @param {Service} service
     ...
     * @returns {Promise<CIDString>}
     */
    static putCar({ endpoint, token, rateLimiter }: Service, car: import('@ipld/car/api').CarReader, { name, onStoredChunk, maxRetries, maxChunkSize, decoders }?: import("./lib/interface.js").PutCarOptions | undefined): Promise<CIDString>;
    /**
     * @param {Service} service
     * @param {CIDString} cid
     * @returns {Promise<Web3Response | null>}
     */
    static get({ endpoint, token, rateLimiter }: Service, cid: CIDString): Promise<Web3Response | null>;
    /**
     * @param {Service} service
     * @param {CIDString} cid
     * @returns {Promise<CIDString>}
     */
    static delete({ endpoint, token, rateLimiter }: Service, cid: CIDString): Promise<CIDString>;
    /**
     * @param {Service} service
     * @param {CIDString} cid
     * @returns {Promise<Status | undefined>}
     */
    static status({ endpoint, token, rateLimiter }: Service, cid: CIDString): Promise<Status | undefined>;
    /**
     * @param {Service} service
     * @param {object} [opts]
