export namespace getOrSetResource {
    namespace options {
        ...
        const pre: {
             ...
             */
            method: (request: import("@hapi/hapi").Request, _h: import("@hapi/hapi").ResponseToolkit) => {
                key: string;
                value: any;
            } | {
                key: any;
...
export namespace showResource {
    ...
    export function handler_1(request: import("@hapi/hapi").Request, h: import("@hapi/hapi").ResponseToolkit): Promise<import("@hapi/hapi").ResponseObject>;
...
export namespace profilesApplyResource {
    ...
    export function handler_2(request: import("@hapi/hapi").Request, h: import("@hapi/hapi").ResponseToolkit): Promise<import("@hapi/hapi").ResponseObject>;
...
export namespace profilesListResource {
    ...
    export function handler_3(request: import("@hapi/hapi").Request, h: import("@hapi/hapi").ResponseToolkit): Promise<import("@hapi/hapi").ResponseObject>;
