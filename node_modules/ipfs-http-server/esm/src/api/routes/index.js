...
export const routes = [];
routes.push(...bitswapRoutes, ...blockRoutes, ...bootstrapRoutes, ...configRoutes, ...dagRoutes, ...debugRoutes, ...dhtRoutes, ...dnsRoutes, ...filesRegularRoutes, ...filesRoutes, ...idRoutes, ...keyRoutes, ...nameRoutes, ...objectRoutes, ...pinRoutes, ...pingRoutes, ...pubsubRoutes, ...repoRoutes, ...resolveRoutes, ...shutdownRoutes, ...statsRoutes, ...swarmRoutes, ...versionRoutes, ...webuiRoutes);