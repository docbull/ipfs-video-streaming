...
export class RootAPI {
     ...
     */
    constructor({ preload, repo, hashers, options }: Context);
...
export type Context = AddAllContext & CatContext & GetContext & ListContext;
export type AddAllContext = import('./add-all').Context;
export type CatContext = import('./cat').Context;
export type GetContext = import('./get').Context;
export type ListContext = import('./ls').Context;
