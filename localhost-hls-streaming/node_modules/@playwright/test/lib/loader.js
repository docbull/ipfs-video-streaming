...
class Loader {
  ...
  async loadTestFile(file, environment) {
    ...
    (0, _transform.setCurrentlyLoadingTestFile)(file);
    ...
    try {
      ...
      (0, _transform.setCurrentlyLoadingTestFile)(null);
...
function folderIsModule(folder) {
  ...
  if (fs.existsSync(packageJson)) {
    ...
    if (parentFolder !== folder) isModule = folderIsModule(parentFolder);else isModule = false;
  }

  folderToIsModuleCache.set(folder, {
    isModule
  });
  return isModule;
}