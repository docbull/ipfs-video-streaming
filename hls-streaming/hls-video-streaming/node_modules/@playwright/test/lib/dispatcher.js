  ...
  async _runJob(worker, testGroup) {
    ...
    const onDone = params => {
      ...
      if (remaining.length) {
        ...
        this._queueHashCount.set(testGroup.workerHash, this._queueHashCount.get(testGroup.workerHash) + 1); // Perhaps we can immediately start the new job if there is a worker available?
