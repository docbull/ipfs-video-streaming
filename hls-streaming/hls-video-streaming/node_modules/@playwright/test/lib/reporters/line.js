...
class LineReporter extends _base.BaseReporter {
  ...
  onTestEnd(test, result) {
    ...
    if (process.env.PW_TEST_DEBUG_REPORTERS) process.stdout.write(`${title + suffix}\n`);else process.stdout.write(`\u001B[1A\u001B[2K${this.fitToScreen(title, suffix) + _safe.default.yellow(suffix)}\n`);
