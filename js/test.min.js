    ...
    (typeof self !== 'undefined' ? self : this, function () {
        var HlsjsIpfsLoader=(()=>{
            ...
            var w=g((p,b)=>{
                ...
                loadInternal(){let{stats:t,context:e,callbacks:i}=this;
                ...
                this._abortFlag[0]=!1,v(this.ipfs,this.hash,o,l,this.debug,this._abortFlag).then(s=>{let r=e.responseType==="arraybuffer"?s:d(s);
                t.loaded=t.total=r.length,t.tload=Math.max(t.tfirst,performance.now());let f={url:e.url,data:r};
                i.onSuccess(f,t,e)},console.error)}};
                ...
                async function m(n,t,e,i,a){
                    ...
                    let end=new Date();
                    console.log(`IPFS cat latency: ${end-start}ms`);
